...
from ..strategies.rsi2_us import signals as st_signals, prepare as st_prepare

cfg = load_config("configs/universe.yaml")
data_path = cfg["data_path"]
out_dir = Path(cfg.get("out_root", "outputs")) / "rsi2_us"
state_path = Path(cfg.get("state_root", "state")) / "rsi2_us_state.csv"
